...
import (
	...
	lmUI "github.com/goquizvibe/backend/feature/learning_materials/ui"
...
func (h *LearningMaterialsHandler) List(w http.ResponseWriter, r *http.Request) error {
	...
	return lmUI.LearningMaterialsListPage(user, materialsWithURLs, t).Render(r.Context(), w)
}
...
func (h *LearningMaterialsHandler) New(w http.ResponseWriter, r *http.Request) error {
	...
	t := middleware.GetTranslator(r.Context())
	return lmUI.LearningMaterialsNewPage(user, t).Render(r.Context(), w)
}
...
func (h *LearningMaterialsHandler) View(w http.ResponseWriter, r *http.Request) error {
	...
	t := middleware.GetTranslator(r.Context())
	return lmUI.LearningMaterialsViewPage(user, material, url, t).Render(r.Context(), w)
}
...
func (h *LearningMaterialsHandler) Preview(w http.ResponseWriter, r *http.Request) error {
	...
	t := middleware.GetTranslator(r.Context())
	return lmUI.LearningMaterialsPreviewPage(user, material, url, t).Render(r.Context(), w)
}
