...
func QuestionCard(data *types.QuizPageData, t locales.Translator) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var3, templ_7745c5c3_Err = templ.ResolveAttributeValue("/quiz/" + data.Questions[0].QuizID.String() + "/navigate")
		if templ_7745c5c3_Err != nil {
		...
		templ_7745c5c3_Var4, templ_7745c5c3_Err = templ.ResolveAttributeValue(strconv.Itoa(data.CurrentIndex))
		if templ_7745c5c3_Err != nil {
		...
		templ_7745c5c3_Var5, templ_7745c5c3_Err = templ.ResolveAttributeValue(strconv.Itoa(data.CurrentIndex + 1))
		if templ_7745c5c3_Err != nil {
		...
		if len(data.Questions[data.CurrentIndex].Images) > 0 {
			...
			for _, img := range data.Questions[data.CurrentIndex].Images {
				...
				templ_7745c5c3_Var7, templ_7745c5c3_Err = templ.ResolveAttributeValue(img.Url)
				if templ_7745c5c3_Err != nil {
		...
		if data.Questions[data.CurrentIndex].Type == models.QuestionTypeChoice {
			...
			if options, ok := data.AnswerOptions[data.CurrentIndex]; ok {
				for _, opt := range options {
					...
					templ_7745c5c3_Var8, templ_7745c5c3_Err = templ.ResolveAttributeValue(opt)
					if templ_7745c5c3_Err != nil {
			...
			templ_7745c5c3_Var10, templ_7745c5c3_Err = templ.ResolveAttributeValue(t.EnterYourAnswer())
			if templ_7745c5c3_Err != nil {
			...
			templ_7745c5c3_Var11, templ_7745c5c3_Err = templ.ResolveAttributeValue(data.Answers[data.CurrentIndex].Text)
			if templ_7745c5c3_Err != nil {
		...
		if data.IsLastQuestion {
			...
			templ_7745c5c3_Var12, templ_7745c5c3_Err = templ.ResolveAttributeValue("/quiz/" + data.Questions[0].QuizID.String() + "/finish?session=" + data.SessionID)
			if templ_7745c5c3_Err != nil {
			...
			templ_7745c5c3_Var13, templ_7745c5c3_Err = templ.ResolveAttributeValue(t.EndQuizThisActionCannotBeUndone())
			if templ_7745c5c3_Err != nil {
		...
		for i := 0; i < data.TotalQuestions; i++ {
			...
			templ_7745c5c3_Var19, templ_7745c5c3_Err = templ.ResolveAttributeValue("/quiz/" + data.Questions[0].QuizID.String() + "/navigate")
			if templ_7745c5c3_Err != nil {
			...
			templ_7745c5c3_Var20, templ_7745c5c3_Err = templ.ResolveAttributeValue(fmt.Sprintf("'current_index':'%d','target_index':'%d'", data.CurrentIndex, i))
			if templ_7745c5c3_Err != nil {
			...
			templ_7745c5c3_Var21, templ_7745c5c3_Err = templ.ResolveAttributeValue(t.Question(i + 1))
			if templ_7745c5c3_Err != nil {
