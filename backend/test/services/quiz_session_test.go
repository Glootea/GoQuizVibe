...
func TestQuizSessionService_NewQuizSessionService(t *testing.T) {
	...
	gamification := gamificationServices.NewGamificationService(mockAttempts, mockStats, NewMockTimeProvider(time.Now()))
	cacheService := &cacheSvc.CacheService{}
	svc := quizServices.NewQuizSessionService(mockAttempts, mockQuizzes, mockQuestions, mockImages, mockUsers, gamification, cacheService)
...
func TestQuizSessionService_GetUserStats(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		...
		gamification := gamificationServices.NewGamificationService(mockAttempts, mockStats, NewMockTimeProvider(now))
		cacheService := &cacheSvc.CacheService{}
