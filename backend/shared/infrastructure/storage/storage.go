...
func (s *StorageService) PutObject(ctx context.Context, objectName string, data []byte, contentType string) error {
	return s.client.PutObject(ctx, objectName, data, contentType)
}

func (s *StorageService) RemoveObject(ctx context.Context, objectName string) error {
	return s.client.RemoveObject(ctx, objectName)
}
...
func (s *StorageService) GetObject(ctx context.Context, objectName string) ([]byte, error) {
	return s.client.GetObject(ctx, objectName)
}